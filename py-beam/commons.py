        ...
        if len(files)>0:
            for file in files:
                if file.endswith(file_ext):
                    ...
                    res_files.append(pref + file_path)
    return res_files

def basename_backwards(path: str, backwards_level: int=2):
